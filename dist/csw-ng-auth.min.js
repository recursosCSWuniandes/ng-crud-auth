/*! csw-ng-auth 2015-12-03 */
!function (a) {
    var b = a.module("authModule", ["ngCookies", "ui.router", "checklist-model"]);
    b.constant("defaultStatus", {status: !1}), b.config(["$stateProvider", "authServiceProvider", function (a, b) {
        var c = b.getValues();
        a.state("login", {
            url: c.loginPath,
    ...
    }]), b.config(["$httpProvider", "authServiceProvider", function (a, b) {
        a.interceptors.push(["$q", "$log", "$location", function (a, c, d) {
            return {
                responseError: function (e) {
                    return 401 === e.status && (c.debug("error 401", e), d.path(b.getValues().loginPath)), 403 === e.status && (c.debug("error 403", e), d.path(b.getValues().forbiddenPath)), a.reject(e)
                }, request: function (a) {
    ...
    var b = a.module("authModule");
    b.controller("authController", ["$scope", "$cookies", "$location", "authService", "defaultStatus", "$log", function (a, b, c, d, e, f) {
        this.errorctrl = e, a.roles = d.getRoles(), d.userAuthenticated().then(function (b) {
            a.currentUser = b.data, "" === a.currentUser || a.menuitems || a.setMenu(a.currentUser)
        }), a.loading = !1, a.$on("logged-in", function (b, c) {
            a.currentUser = c.data, a.setMenu(a.currentUser)
        }), a.setMenu = function (b) {
            a.menuitems = [];
            for (var c = 0; c < b.roles.length; c++)for (var d in a.roles)if (b.roles[c] === d)for (var e in a.roles[d])a.menuitems.push(a.roles[d][e])
        }, a.isAuthenticated = function () {
            return !!a.currentUser
        }, this.login = function (b) {
            var c = this;
            b && b.userName && b.password && (a.loading = !0, d.login(b).then(function (a) {
            }, function (a) {
                c.errorctrl = {status: !0, type: "danger", msg: ":" + a.data}, f.error("Error", a)
            })["finally"](function () {
                a.loading = !1
            }))
        }, a.logout = function () {
            ...
            var c = this;
            b && b.hasOwnProperty("userName") && b.hasOwnProperty("password") && b.hasOwnProperty("confirmPassword") && b.hasOwnProperty("email") && b.hasOwnProperty("givenName") && b.hasOwnProperty("surName") ? b.password !== b.confirmPassword ? this.errorctrl = {
                status: !0,
                type: "warning",
                msg: ": Passwords must be equals"
            } : (a.loading = !0, d.register(b).then(function (a) {
                c.errorctrl = {status: !0, type: "success", msg: ":  User registered successfully"}
            }, function (a) {
                c.errorctrl = {status: !0, type: "danger", msg: ": " + a.data.substring(66)}
            })["finally"](function () {
                a.loading = !1
            })) : c.errorctrl = {status: !0, type: "danger", msg: ": You must complete all fields"}
        }, this.goToForgotPass = function () {
            d.goToForgotPass()
        }, this.forgotPass = function (b) {
            var c = this;
            b ? (a.loading = !0, d.forgotPass(b).then(function (a) {
            }, function (a) {
                c.errorctrl = {status: !0, type: "danger", msg: ":" + a.data.substring(66)}
            })["finally"](function () {
                a.loading = !1
            })) : c.errorctrl = {status: !0, type: "danger", msg: ":You must to enter an email address"}
        }, a.goToLogin = function () {
            d.goToLogin()
        }, this.goBack = function () {
            d.goToBack()
        }, a.goToSuccess = function () {
            d.goToSuccess()
        }
    }])
}(window.angular), function (a) {
    var b = a.module("authModule");
    b.directive("loginButton", [function () {
        return {scope: {}, restrict: "E", templateUrl: "src/templates/button.html", controller: "authController"}
    }])
}(window.angular), function (a) {
    var b = a.module("authModule");
    b.provider("authService", function () {
        var b = {
            apiUrl: "api/users/",
            successPath: "/product",
            loginPath: "/login",
